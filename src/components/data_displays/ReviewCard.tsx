    ...
    <View style={props.wrapperStyle}>
      ...
      <View>
        ...
        <View style={{marginHorizontal: 20, paddingVertical: 10}}>
          <TouchableOpacity disabled={props.textTouchingDisable} onPress={() => nav.navigate("ReviewCardDetailScreen")}><CsText numberOfLines={props.numberOfLines}>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptatem sunt delectus, accusamus cupiditate sequi suscipit fugit atque culpa ipsa excepturi aliquid ratione! Necessitatibus molestias eos repudiandae quaerat praesentium soluta officia.</CsText></TouchableOpacity>
