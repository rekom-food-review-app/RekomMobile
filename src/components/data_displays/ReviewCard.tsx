...
function ReviewCard(props: ReviewCardProps)
{
  ...
  return (
    <View style={props.wrapperStyle}>
      <TouchableOpacity onPress={() => nav.navigate("OtherProfileScreen")}>
        <UserActionInfo avatarUrl={props.rekomerAvatarUrl} actionDate={props.reviewAt} fullname={props.rekomerName} wrapperStyle={{marginBottom: 10, paddingHorizontal: 20}}/>
      </TouchableOpacity>
      <View>
        ...
        <View style={{marginHorizontal: 20, paddingVertical: 10}}>
          <TouchableOpacity disabled={props.textTouchingDisable} onPress={() => nav.navigate("ReviewCardDetailScreen")}><CsText numberOfLines={props.numberOfLines}>{props.reviewContent}</CsText></TouchableOpacity>
          ...
          </View>
          {
            ...
            ? (
              ...
              <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                ...
                <IconButton onPress={() => nav.navigate("ReviewCardDetailScreen")} size={'sm'} typeBtn={'inactive'} source={require('../../assets/image/cmt.png')}>{10}</IconButton>
              </View>
