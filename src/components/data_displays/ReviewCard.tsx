    ...
    <View>
      ...
      <View>
        ...
        <View style={{marginHorizontal: 20, paddingVertical: 10}}>
          <CsText numberOfLines={3}>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptatem sunt delectus, accusamus cupiditate sequi suscipit fugit atque culpa ipsa excepturi aliquid ratione! Necessitatibus molestias eos repudiandae quaerat praesentium soluta officia.</CsText>
